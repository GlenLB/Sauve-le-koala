...
class Sprite {
    ...
    static AllLoaded(): boolean {
        return Brick.load && BrickCracked.load && VioletBrick.load && VioletBrickCracked.load && Paddle.load && Koala.load
    }
}
...
class PlayerClass {
    ...
    win() {
        ...
        let includes13: boolean = BrickClass.isInclude(13);
        let includes16: boolean = BrickClass.isInclude(16);
        let includes19: boolean = BrickClass.isInclude(19);
        let includes20: boolean = BrickClass.isInclude(20);
        let includes21: boolean = BrickClass.isInclude(21);
        let includes22: boolean = BrickClass.isInclude(22);
    ...
    drawWin() {
        ...
        this.buttonWin.innerText = "Aller au niveau 3";
        this.buttonWin.addEventListener("click", () => {
            window.location.href = "http://" + window.location.host + "/sauve-le-koala?level=3&scroll=" + window.scrollY;
        });
    }
