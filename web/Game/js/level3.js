...
var PlayerClass = (function () {
    ...
    PlayerClass.prototype.drawWin = function () {
        ...
        this.buttonWin.innerText = "Aller au niveau 4";
        this.buttonWin.addEventListener("click", function () {
            window.location.href = "http://" + window.location.host + "/sauve-le-koala?level=4&scroll=" + window.scrollY;
        });
    };
